/**
 * MOD-ER-LIBRARY — account-less multi-routine library (localStorage).
 * Normalizes legacy flat exercises[] → sessions[] on load (AD-018).
 */
(function (global) {
  ...
  function renderLibraryPage() {
    ...
    routines.forEach((r) => {
      ...
      const source =
        r.source === "import" ? " · imported" : " · personal browser save";
      ...
      editLink.href = "/author?id=" + encodeURIComponent(r.id);
