/**
 * MOD-ER-AUTHORING â€” ordered dual-metric exercise editor (AD-015, AD-017).
...
(function () {
  ...
  function addRow(data) {
    ...
    card.innerHTML = `
      ...
      <label class="field"><span>Visual URL (optional)</span>
        <input type="url" name="visual_url" placeholder="https://â€¦ or leave blank for placeholder"></label>
  ...
  form.addEventListener("submit", (ev) => {
    ...
    status.textContent = "Saved â€œ" + name + "â€. Opening My routinesâ€¦";
    setTimeout(() => {
